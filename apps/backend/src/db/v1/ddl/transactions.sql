...
CREATE TABLE IF NOT EXISTS transactions.transactions (
  ...
  CONSTRAINT fk_correction_transaction_id FOREIGN KEY (correction_id) REFERENCES transactions.transactions (id),
  CONSTRAINT fk_corrected_transaction_id FOREIGN KEY (corrected_id) REFERENCES transactions.transactions (id),

...
INSERT INTO utils.tax_categories (category, description)
VALUES
...
INSERT INTO utils.payment_methods (name, description)
VALUES
    ('TRANSFER', NULL),
    ('EC', NULL),
    ('CREDIT_CARD', NULL),
...
INSERT INTO utils.bank_accounts (account, bank, owner, type, annual_fee)
VALUES

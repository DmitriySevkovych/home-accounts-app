    ...
    'inline-flex items-center justify-center rounded-full text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                ...
                primary:
                    'bg-accent hover:bg-accent-lighter text-darkest font-medium',
                outline:
                    'border border-input bg-background hover:bg-accent hover:text-accent-foreground',
                secondary:
                    'bg-darkest text-white font-medium rounded-full hover:bg-secondary-lighter',
                ghost: 'hover:bg-accent hover:text-accent-foreground',
                link: 'text-primary underline-offset-4 hover:underline',
                destructive:
                    'border border-darkest bg-background hover:bg-accent hover:text-accent-foreground font-medium',
            },
            size: {
